  ...
  if (newsArticle === undefined) {
    ...
    return (
      <div className="right">
        ...
        <div id="sports-news-container" style={{backgroundImage: `url(${newsArticle.image_url})`}}>
          {newsArticle.image_url? null : <Image
            width={500}
            height={500}
          ...
          <div id="news-text">
            ...
            <p>{newsArticle.description ? newsArticle.description.slice(0,100)+'...' : newsArticle.content.slice(0,100)+'...'}</p>
            <p style={newsStyles}>{newsArticle.creator? newsArticle.creator[0] : "N/A"} - {formattedDate}</p>
            <a id="read-more" href={newsArticle.link} target="_blank" rel="noopener noreferrer">
            READ MORE
            </a>
          </div>
        </div>
