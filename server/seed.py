...
headshots_female_players = ["https://images.squarespace-cdn.com/content/v1/5fde0871cb96363ef0b6b786/1609359712401-O4PFKIDAKRQ52LYQ6ND2/shoot-me-now-teenage-model-girl-headshot", "https://images.squarespace-cdn.com/content/v1/555bd2ece4b00127a2b1264f/1621047421406-16OADFQKV0U0MVJNVVVH/26_teen_youth_headshot_michael_verity_photography.jpg",
                            "https://images.squarespace-cdn.com/content/v1/590814dc1e5b6c7f60b5e133/1507321982367-WWOUX9M3OSLT06AT4DCL/Girl+next+Door+copy.jpg?format=1000w", "https://frphoto.com/wp-content/uploads/2018/02/14-1149-post/Milwaukee-Headshot-Photographer_FRPhoto_170720A_C1_38.jpg", "https://i.pinimg.com/236x/cc/4a/6c/cc4a6c12fedb412d6e1f52ff691e6600.jpg"]
headshots_male_players = ["https://4.bp.blogspot.com/-NOYppoNXnoA/Vl0BnGtXEFI/AAAAAAABU1s/fanK3tscSYA/s1600/Actor%2Bheadshots_kids_teens_232.jpg", "https://i.pinimg.com/236x/01/22/91/012291480ee40fe3a424619b99c1f3bb.jpg",
                          "https://2.bp.blogspot.com/-qgnJa1jD_YM/Vl0BlmzP32I/AAAAAAABU1g/qltyhBdTjUk/s1600/Actor%2Bheadshots_kids_teens_230.jpg", "https://i.pinimg.com/736x/e7/e0/8a/e7e08a14742970c38519fa66ab6e22ac.jpg", "https://tracywrightcorvo.com/wp-content/uploads/2019/02/Tracy_Wright_Corvo_Photography_teen_actor_headshot_male-087.jpg"]
headshots_female_coaches = ["https://images.squarespace-cdn.com/content/v1/5f4506ee3afb2b7624880125/1656426869152-0A0FYQ2BFKVIWA8PJOFA/working-mom-role.jpg",
                            "https://beruckstudios.com/wp-content/uploads/bb-plugin/cache/CFO-Headshot-portrait.jpg"]
headshots_male_coaches = ["https://i.pinimg.com/236x/e8/7e/a5/e87ea5f1565b458bb866112909f1a62e.jpg",
                          "https://images.squarespace-cdn.com/content/v1/624f4bb135fbf60489e1bccf/c97c249c-eef3-402f-bacb-de2e52e2d8be/Jay+Ellis+actor+headshotsjpgweb.jpg"]
...
def create_players(teams):
    ...
    for _ in range(8):
        player = Player(
            ...
            birthday=fake.date_between_dates(date_start=datetime(
                2009, 1, 1), date_end=datetime(2009, 12, 31)),
...
def create_events(teams, coaches):
    ...
    for _ in range(10):
        ...
        event = Event(
            ...
            date = fake.date_between_dates(date_start=datetime(2025, 1, 1), date_end=datetime(2025, 12, 31)),
